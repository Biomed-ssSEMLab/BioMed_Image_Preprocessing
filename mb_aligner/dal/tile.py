...
class Tile(object):
    ...
    def __init__(self, img_fname, **kwargs):
        ...
        self._width = None
        self._height = None
        self._bbox = []  # [left, right, top, bottom]
        self._layer = None
        self._mfov_idx = None
        self._tile_idx = None
        ...
        if len(kwargs) > 0:
            ...
            if "bbox" in kwargs:
                self._bbox = kwargs["bbox"]  # [left, right, top, bottom]
    ...
    def create_from_input(cls, img_fname, tile_size, tile_loc, layer, mfov_idx, tile_idx):
        ...
        if "://" in img_fname:
            ...
            print("change osfs to file: tile.py")
            img_url = "osfs://{}".format(img_fname)
        
        tilespec = {"mipmapLevels" : {"0" : {"imageUrl" : img_url}},
                    "minIntensity" : 0.0,
                    "maxIntensity" : 255.0,
                    "layer" : layer,
                    "transforms" : [{"className" : "mpicbg.trakem2.transform.TranslationModel2D",
                    ...
                    "bbox" : [tile_loc[0], tile_loc[0] + tile_size[1],
                              tile_loc[1], tile_loc[1] + tile_size[0]]}  # [left, right, top, bottom]
        
        ''' 
        #rotate 90 
        print("get the tilespec rotated 90")
        ...
        tilespec = {"mipmapLevels" : {"0" : {"imageUrl" : img_url}},
                    ...
                    "layer" : layer,
                    "transforms" : [{"className" : "mpicbg.trakem2.transform.TranslationModel2D",
                                     "dataString" : "{0} {1}".format(tile_loc[1], tile_loc[0])}],
                    "width" : tile_size[1],
                    "height" : tile_size[0],
                    "mfov" : mfov_idx,
                    "tile_index" : tile_idx,
                    "bbox" : [tile_loc[1], tile_loc[1] + tile_size[1],
                              -tile_loc[0] - tile_size[0], -tile_loc[0]]}  # [left, right, top, bottom]
        ...
        tilespec = {"mipmapLevels" : {"0" : {"imageUrl" : img_url}},
                    ...
                    "mfov" : mfov_idx,
                    "tile_index" : tile_idx,
                    "bbox" : [-tile_loc[1] - tile_size[1], -tile_loc[1],
                              tile_loc[0] , tile_loc[0] + tile_size[0]]}  # [left, right, top, bottom]
        
        '''
        '''
        #rotate 180
        print("get the tilespec rotated 180")
        ...
        tilespec = {"mipmapLevels" : {"0" : {"imageUrl" : img_url}},
                    ...
                    "mfov" : mfov_idx,
                    "tile_index" : tile_idx,
                    "bbox" : [-tile_loc[0] - tile_size[1], -tile_loc[0],
                              -tile_loc[1] - tile_size[0], -tile_loc[1]]}  # [left, right, top, bottom]
    ...
    def tilespec(self):
        ...
        tilespec = {"mipmapLevels" : {"0" : {"imageUrl" : img_url}},
                    ...
                    "bbox" : self._bbox  # [left, right, top, bottom]
            }
        return tilespec
