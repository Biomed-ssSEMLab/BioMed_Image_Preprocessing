...
class BlobDetector2D(object):
    ...
    def __init__(self, **kwargs):
        ...
        self._sift_detector = cv2.SIFT_create(**sift_params)
    ...
    def _create_blob_detector(**kwargs):
        ...
        params.minArea = args.get("minArea", 200)
    ...
    def detectAndCompute(self, img, kps=None):
        ...
        if blob_kps is None or len(blob_kps) == 0:
            ...
            blob_pts, blob_descs = self._sift_detector.compute(img_filtered, blob_kps)  # blob_pts就是blob_kps
