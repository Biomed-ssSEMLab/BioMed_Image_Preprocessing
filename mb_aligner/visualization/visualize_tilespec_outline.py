...
if __name__ == '__main__':
    # in_files = sys.argv[1:]
    in_files = [
        '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_output_dir/0001_W01_Sec001.json',
        '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_output_dir/0002_W01_Sec002.json'
                ]
