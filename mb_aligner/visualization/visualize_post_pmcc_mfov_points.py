...
def load_tilespecs(ts_fname):
    ...
    wafer_num = int(os.path.basename(ts_fname).split('_')[1].split('W')[1])
    # wafer_num = 1
    # sec_num = int(os.path.basename(ts_fname).split('_')[-1].split('S')[1].split('R')[0])
    sec_num = int(os.path.basename(ts_fname).split('Sec')[1].split('.')[0])
...
def main():
    ...
    #                     default = '/media/liuxz/3EA0B4CEA0B48E41/output/test1/test/3d_putput_dir/aaaaa.json')
    # parser.add_argument('ts1_fname', metavar='ts1_fname', type=str,
    #                     help='The first section tilespec file name',
    #                     default = '/media/liuxz/3EA0B4CEA0B48E41/output/test1/test/3d_putput_dir/0001_W01_Sec001.json')
    # parser.add_argument('ts2_fname', metavar='ts2_fname', type=str,
    #                     help = 'The second section tilespec file name',
    #                     default='/media/liuxz/3EA0B4CEA0B48E41/output/test1/test/3d_putput_dir/0002_W01_Sec002.json')
    ...
    #                     default='/media/liuxz/3EA0B4CEA0B48E41/output/test1/test/output')

    args = parser.parse_args()

    # pmcc_matches_file = '/media/liuxz/3EA0B4CEA0B48E41/output/test1/test/3d_work_dir/W01_Sec001_W01_Sec002.pkl'
    # pmcc_matches_file = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_work_dir/fine_matches_filtered/W01_Sec001_W01_Sec002.pkl'
    # ts1_fname = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_output_dir/0001_W01_Sec001.json'
    # ts2_fname = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_output_dir/0002_W01_Sec002.json'
    pmcc_matches_file = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_3section/3d_work_dir/fine_matches_filtered/W01_Sec001_W01_Sec002.pkl'
    ts1_fname = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_3section/3d_output_dir/0001_W01_Sec001.json'
    ts2_fname = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_3section/3d_output_dir/0002_W01_Sec002.json'
    output_file_prefix = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/test4'

    visualize_post_pmcc_mfov_points(pmcc_matches_file, ts1_fname, ts2_fname, args.mfov, args.scale, output_file_prefix)
