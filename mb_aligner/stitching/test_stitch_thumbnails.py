...
def render_section(out_fname, section, ds_rate):
    ...
    for tile in section.tiles():
     ...
     #   mfov_mask = tile.mask
        ...
        mfov_mask = (mfov_image > 0).astype(np.uint8)
        ...
        # mfov_images = cv2.fastNlMeansDenoising(mfov_image, None, 5, 7, 21)
        # mfov_image = mfov_images.astype(np.uint8)

        clahe = cv2.createCLAHE(clipLimit=2.0, tileGridSize=(8, 8))
        mfov_image = clahe.apply(mfov_image)
...
#    section_num = 10
    section_dir = '/userhome/output/retina_wafer2/stitch/ECS_test9_cropped_010_S011R1-1.json'
    section_num = 11
    out_jpg_fname ='/userhome/output/test_retina/section11.jpg'
    # out_fname = '/media/liuxz/3EA0B4CEA0B48E41/output/test/test1/ECS_test9_cropped_010_S2R1-1.json'
