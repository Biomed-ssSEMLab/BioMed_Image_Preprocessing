...
def preprocess(img1, img2, overlap_w, flag_half):
    ...
    if overlap_w > img1.shape[1] or overlap_w > img2.shape[1]:
        # width of the overlapped area between two images
    ...
    if flag_half:
        # option to blend the left half of the first image and the right half of the second image
...
if __name__ == '__main__':
    ...
    flag_half =
    img1 = cv2.imread('/media/liuxz/3EA0B4CEA0B48E41/output/blending/1.bmp')
    img2 = cv2.imread('/media/liuxz/3EA0B4CEA0B48E41/output/blending/2.bmp')
    overlap_w =
