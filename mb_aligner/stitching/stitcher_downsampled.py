...
if __name__ == '__main__':
    section_dir = '/media/liuxz/3EA0B4CEA0B48E41/output/001_S2R1/full_image_coordinates_1.txt'
    section_num = 1
    ...
    processes_num = 8
    out_fname = '/media/liuxz/3EA0B4CEA0B48E41/output/test/ECS_test9_cropped_010_S3R1.json'
# 
