...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--output_dir', type=str,
                        ...
                        default='/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/test4')
...
If not set, each job will render a single tile (default: None)',
    ...
    ts_fname = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/output/output_1/3d_work_dir_1mFov/3d_output_dir/0001_W01_Sec001.json'
    ...
    if args.bbox is None:
        entire_image_bbox = common.read_bboxes_grep_pool([ts_fname], pool)
