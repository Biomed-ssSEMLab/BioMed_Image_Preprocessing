...
def parse_args(args=None):
    ...
    parser.add_argument("--wafer_folder", metavar="wafer_folder",
                        ...
                        default='/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/Experiment_0326_coatedTape_SS6_20210326_16-11-56_1')
    parser.add_argument("-o", "--output_file", metavar="output_file",
                        ...
                        default="/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/my_mb_aligner/output/wafer1.txt"
                        )
...
if __name__ == '__main__':
    args = parse_args()
    # args.wafer_folder = '/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/Experiment_0326_coatedTape_SS6_20210326_16-11-56_1'
