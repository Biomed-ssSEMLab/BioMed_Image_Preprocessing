...
def parse_args(args=None):
    ...
    parser.add_argument("--sections_list_file", metavar="sections_list_file",
                        ...
                        default='/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/Experiment_0326_coatedTape_SS6_20210326_16-11-56/region_names.csv')
    parser.add_argument("-o", "--output_dir", metavar="output_dir",
                        help="The output directory where the stitched tilespecs will be stored",
                        default='  default="/media/liuxz/3EA0B4CEA0B48E41/mb_aligner/my_mb_aligner/output')
...
def run_stitcher(args):
    ...
    secs_dirs = [dirname.strip() for dirname in secs_dirs]
